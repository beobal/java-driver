...
import static com.datastax.driver.core.FrameDecoderCrc.HEADER_LENGTH;
import static com.datastax.driver.core.FrameDecoderCrc.isSelfContained;
import static com.datastax.driver.core.FrameDecoderCrc.payloadLength;
import static com.datastax.driver.core.FrameDecoderCrc.readHeader6b;
import static com.datastax.driver.core.FrameDecoderCrc.verifyHeader6b;
...
{
    private FrameDecoderUnprotected(BufferPoolAllocator allocator)
    {
        super(allocator);
    }
