...
import com.datastax.driver.core.utils.BufferType;
...
import static com.datastax.driver.core.Crc.crc24;
import static com.datastax.driver.core.Crc.crc32;
...
class FrameEncoderLZ4 extends FrameEncoder
{
    ...
    public ByteBuf encode(boolean isSelfContained, ByteBuffer in)
    {
        ...
        try
        {
            ...
            {
                FrameDecoder.copyBytes(in, in.position(), frame, HEADER_LENGTH, uncompressedLength);
